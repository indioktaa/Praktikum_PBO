        ...
        while (true) {
            ...
            switch (pilihan) {
                ...
                case 3 -> {
                    ...
                    String id = scanner.nextLine();
                    if (!produkService.hapusProduk(id)) {
                ...
                case 4 -> {
                    ...
                    String id = scanner.nextLine();
                    if (produkService.cariProduk(id) == null) {
                        System.out.println("Produk dengan ID tersebut tidak ditemukan!");
                    } else {
        ...
        while (true) {
            ...
            switch (pilihan) {
                ...
                case 3 -> {
                    ...
                    String id = scanner.nextLine();
                    if (!jasaService.hapusJasa(id)) {
                        System.out.println("Jasa dengan ID tersebut tidak ditemukan!");
                    }
                }
                case 4 -> {
                    System.out.print("Masukkan ID Jasa yang akan diupdate: ");
                    String id = scanner.nextLine();
                    if (jasaService.cariJasa(id) == null) {
                        System.out.println("Jasa dengan ID tersebut tidak ditemukan!");
                    } else {
                        System.out.print("Nama Baru: ");
                        String nama = scanner.nextLine();
